...
public:
    agent::ModelResponse response{{agent::TextBlock{"cumulative summary"}},
                                  agent::StopReason::EndTurn, 0, 0, "request-local"};
...
TEST_CASE(compactor_accepts_exact_utf8_byte_boundary_and_terminal_stop_sequence) {
    ...
    model.response = {{agent::TextBlock{"中文"}}, agent::StopReason::StopSequence, 0, 0, "request-local"};
    auto request = input();
...
TEST_CASE(compactor_rejects_every_invalid_response_without_echoing_provider_text) {
    const std::vector<agent::ModelResponse> responses{
        {{}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{""}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{" \t\r\n"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"\xE2\x80\x83"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"\xC0\xAF"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"\xED\xA0\x80"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"\xF4\x90\x80\x80"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"\xE4\xB8"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{std::string("a\0b", 3)}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"provider-secret-body"}, agent::TextBlock{"second"}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::ToolUseBlock{{"id", "tool", agent::Value::object({})}}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::ToolResultBlock{{"id", "provider-secret-body", false}}}, agent::StopReason::EndTurn, 0, 0, "request-local"},
        {{agent::TextBlock{"provider-secret-body"}}, agent::StopReason::ToolUse, 0, 0, "request-local"},
        {{agent::TextBlock{"provider-secret-body"}}, agent::StopReason::MaxTokens, 0, 0, "request-local"},
        {{agent::TextBlock{"provider-secret-body"}}, agent::StopReason::Unknown, 0, 0, "request-local"}};
