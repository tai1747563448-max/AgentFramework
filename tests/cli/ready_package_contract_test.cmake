...
# Only unique synthetic test data is created here. No source or real staging
# directory is removed or rewritten by this contract test.
...
# Exercise the real staging script in a synthetic checkout. A prior staging
# implementation recursively removed the entire Ready directory, including
# application-created state that was not part of the managed package.
...
# An existing managed filename can still be a hard link to data outside Ready.
# Staging must replace the directory entry, not overwrite the shared file body.
