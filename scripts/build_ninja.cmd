@echo off
REM Manually link agent.exe (bypassing broken vs_link_exe) then run
REM ninja directly for any remaining targets so ninja's dependency
REM tracker is happy.
