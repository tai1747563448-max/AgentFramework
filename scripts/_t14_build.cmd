...
cmake --build . --config Release --target mcp_fixture_copy -j 4
cmake --build . --config Release --target mcp_json_rpc_tests mcp_stdio_client_tests mcp_server_registry_tests composite_tool_gateway_tests -j 4
