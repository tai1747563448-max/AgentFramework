...
cmake --build build\vs2022 --config Release --target workspace_tool_gateway_tests runtime_engine_tests terminal_presenter_tests -j 4
if errorlevel 1 exit /b 1
cd build\vs2022
workspace_tool_gateway_tests.exe
